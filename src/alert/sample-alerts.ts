...
const SAMPLE_ALERTS: Array<Alert> = [
  {
    ...
    triaged: { user: "john.smith@example.com", date: NOW.minus({ minutes: 2 }).toJSDate() },
  ...
  },
  {
    ...
    triaged: { user: "melissa.chen@example.com", date: NOW.minus({ days: 3 }).toJSDate() },
    reviewed: { user: "security.lead@example.com", date: NOW.minus({ days: 3 }).toJSDate(), },
    category: AlertCategory.SIEM,
  ...
  },
  {
    ...
    triaged: { user: "alice.johnson@example.com", date: NOW.minus({ days: 5 }).toJSDate() },
    reviewed: { user: "bob.thompson@example.com", date: NOW.minus({ days: 5 }).toJSDate(), },
    closed: { date: NOW.minus({ days: 5 }).toJSDate(), user: "bob.thompson@example.com", notes: "Verified with user - business trip to different timezone" },
    category: AlertCategory.SIEM,
  ...
  },
  {
    ...
    triaged: { user: "john.smith@example.com", date: NOW.minus({ hours: 1 }).toJSDate() },
    category: AlertCategory.SIEM,
  ...
  },
  {
    ...
    createdOn: NOW.minus({ minutes: 2 }).toJSDate(),
    assignedTo: "melissa.chen@example.com",
    triaged: { user: "alice.johnson@example.com", date: NOW.minus({ minutes: 2 }).toJSDate() },
    category: AlertCategory.SIEM,
    sourceHost: "unknown",
  ...
  },
  {
    ...
    triaged: { user: "bob.thompson@example.com", date: NOW.minus({ hours: 17 }).toJSDate() },
    category: AlertCategory.SIEM,
  ...
  },
  {
    ...
    assignedTo: "alice.johnson@example.com",
    triaged: { user: "alice.johnson@example.com", date: NOW.minus({ years: 2 }).toJSDate() },
    reviewed: { user: "alice.johnson@example.com", date: NOW.minus({ years: 2 }).toJSDate(), },
    closed: { date: NOW.minus({ years: 2 }).toJSDate(), user: "melissa.chen@example.com", notes: "Planned maintenance by IT team" },
    category: AlertCategory.SIEM,
  ...
  },
  {
    ...
    assignedTo: "security.lead@example.com",
    triaged: { user: "john.smith@example.com", date: NOW.minus({ days: 18 }).toJSDate() },
    reviewed: { user: "melissa.chen@example.com", date: NOW.minus({ days: 17 }).toJSDate(), },
    escalated: { user: "melissa.chen@example.com", date: NOW.minus({ days: 16 }).toJSDate(), },
    category: AlertCategory.SIEM,
    sourceHost: "unknown",
  ...
  },
  {
    ...
    assignedTo: "bob.thompson@example.com",
    triaged: { user: "bob.thompson@example.com", date: NOW.minus({ years: 1 }).toJSDate() },
    reviewed: { user: "bob.thompson@example.com", date: NOW.minus({ years: 1 }).toJSDate(), },
    closed: { date: NOW.minus({ years: 1 }).toJSDate(), user: "bob.thompson@example.com", notes: "Authorized database migration test" },
    category: AlertCategory.SIEM,
  ...
  },
  {
    ...
    assignedTo: "security.lead@example.com",
    triaged: { user: "john.smith@example.com", date: NOW.minus({ minutes: 4 }).toJSDate() },
    category: AlertCategory.SIEM,
    sourceHost: "multiple",
  ...
  },
  {
    ...
    assignedTo: "john.smith@example.com",
    triaged: { user: "john.smith@example.com", date: NOW.minus({ days: 4 }).toJSDate() },
    category: AlertCategory.EDR,
    isQuarantined: true,
  ...
  },
  {
    ...
    createdOn: NOW.minus({ hours: 2 }).toJSDate(),
    assignedTo: "security.lead@example.com",
    triaged: { user: "melissa.chen@example.com", date: NOW.minus({ hours: 2 }).toJSDate() },
    reviewed: { user: "security.lead@example.com", date: NOW.minus({ hours: 2 }).toJSDate(), },
    category: AlertCategory.EDR,
    isQuarantined: true,
    process: "unknown.exe",
  ...
  },
  {
    ...
    assignedTo: "bob.thompson@example.com",
    triaged: { user: "bob.thompson@example.com", date: NOW.minus({ days: 2 }).toJSDate() },
    category: AlertCategory.EDR,
    isQuarantined: false,
  ...
  },
  {
    ...
    assignedTo: "security.lead@example.com",
    triaged: { user: "john.smith@example.com", date: NOW.minus({ hours: 4 }).toJSDate() },
    category: AlertCategory.EDR,
    isQuarantined: true,
  ...
  },
  {
    ...
    createdOn: NOW.minus({ days: 3 }).toJSDate(),
    assignedTo: "alice.johnson@example.com",
    triaged: { user: "alice.johnson@example.com", date: NOW.minus({ days: 3 }).toJSDate() },
    category: AlertCategory.EDR,
    isQuarantined: false,
  ...
  },
  {
    ...
    createdOn: NOW.minus({ days: 1 }).toJSDate(),
    assignedTo: "security.lead@example.com",
    triaged: { user: "melissa.chen@example.com", date: NOW.minus({ days: 1 }).toJSDate() },
    reviewed: { user: "bob.thompson@example.com", date: NOW.minus({ days: 1 }).toJSDate(), },
    category: AlertCategory.EDR,
    isQuarantined: false,
  ...
  },
  {
    ...
    createdOn: NOW.minus({ days: 5 }).toJSDate(),
    assignedTo: "john.smith@example.com",
    triaged: { user: "john.smith@example.com", date: NOW.minus({ days: 5 }).toJSDate() },
    reviewed: { user: "john.smith@example.com", date: NOW.minus({ days: 5 }).toJSDate(), },
    closed: { date: NOW.minus({ days: 5 }).toJSDate(), user: "john.smith@example.com", notes: "Software installation with legitimate registry changes" },
    category: AlertCategory.EDR,
    isQuarantined: false,
  ...
  },
  {
    ...
    reviewed: { user: "melissa.chen@example.com", date: NOW.minus({ months: 9 }).toJSDate(), },
    closed: { date: NOW.minus({ months: 9 }).toJSDate(), user: "melissa.chen@example.com", notes: "Approved productivity extension from corporate store" },
    category: AlertCategory.EDR,
    isQuarantined: false,
    process: "chrome.exe",
    parentProcess: "explorer.exe",
